        ...
        <TabsContent value="converter" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Convert various file types to PDF. (Functionality is for demonstration)</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid w-full items-center gap-1.5">
                <Label htmlFor="file-converter">Select File</Label>
                <Input id="file-converter" type="file" />
              </div>
        ...
        <TabsContent value="merger" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Combine multiple PDF files into one. (Functionality is for demonstration)</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid w-full items-center gap-1.5">
                <Label htmlFor="file-merger">Select Files</Label>
                <Input id="file-merger" type="file" multiple />
              </div>
              <Button className="w-full">
